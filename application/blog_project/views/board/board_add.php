<main role="main" class="container">
    <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">게시물 등록</h6>
            <small>게시물 등록 합니다.</small>
        </div>
    </div>
    ...
    <input type="hidden" name="mode" value="add">
        <h6 class="border-bottom border-gray pb-2 mb-0">게시물 등록</h6>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    <div class="col-3">카테고리</div>
                    <div class="col-9">
                        <input class="form-control" type="text" name="board_category" placeholder="카테고리(,구분)">
                    </div>
                </div>
            </div>
        </div>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" name="board_tag" placeholder="태그(,구분)">
                    </div>
                </div>
            </div>
        </div>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" name="board_thumnail" placeholder="썸네일 URL">
                    </div>
                </div>
            </div>
        </div>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" name="board_title" placeholder="제목">
                    </div>
                </div>
            </div>
        </div>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    ...
                    <div class="col-9">
                        <textarea class="form-control span5" name="board_comment" placeholder="간략 내용" style="height: 150px;"></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    ...
                    <div class="col-9">
                        <textarea class="form-control span5" name="board_article" placeholder="상세 내용" style="height: 600px;"></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="media text-muted pt-3">
            <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                <div class="row">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" name="board_date" placeholder="날짜(0000-00-00 00:00:00)">
                    </div>
                </div>
            </div>
        </div>
